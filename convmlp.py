...
from util.tokenizer import ConvTokenizer
from util.modules import ConvStage, BasicStage
...
def _convmlp(arch, pretrained, progress, classifier_head, blocks, dims, mlp_ratios, *args, **kwargs):
    ...
    if pretrained and arch in model_urls:
        ...
        pretrained_dict = {k: v for k, v in state_dict.items() if (k in model_dict and 'head' not in k)}
        # 更新权重
